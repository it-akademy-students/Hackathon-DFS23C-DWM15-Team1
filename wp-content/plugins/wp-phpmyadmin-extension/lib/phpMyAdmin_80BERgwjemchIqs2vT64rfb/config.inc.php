...
$cfg['blowfish_secret']					= 'Xl=?6\\P5K+X9I)?+NG4:Dwm1jQR4YoYP' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/php/RUSH/Hackathon-DFS23C-DWM15-Team1/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_80BERgwjemchIqs2vT64rfb/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
